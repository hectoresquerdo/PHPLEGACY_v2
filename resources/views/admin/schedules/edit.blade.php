...
@section('content')
    ...
    <form class="form-horizontal" action="{{ url('/admin/schedules/' . $schedule->id) }}" method="POST"
        ...
        <div class="form-group">
            <label class="control-label" for="time_start">{{ 'Day start' }}</label>
            <input class="form-control" type="date" name="time_start" id="time_start" value="{{ $schedule->time_start }}">
        </div>
        <div class="form-group">
            <label class="control-label" for="time_end">{{ 'Day End' }}</label>
            <input class="form-control" type="date" name="time_end" id="time_end" value="{{ $schedule->time_end }}">
        </div>
