...
@section('content_header')
    <h1>Subjects Section: Create and modify Subjects </h1>
@stop
...
@section('content')
    ...
    <form action="{{ url('/admin/schedules') }}" method="POST" enctype="multiplart/form-data">
        ...
        <div class="form-group">
            <label class="control-label" for="time_start">{{ 'Start' }}</label>
            <input class="form-control" type="date" name="time_start" id="time_start" value="">
        </div>
        <div class="form-group">
            <label class="control-label" for="time_end">{{ 'End' }}</label>
            <input class="form-control" type="date" name="time_end" id="time_end" value="">
        </div>
        <div class="form-group">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-secondary"
                                                href="{{ url('/admin/schedules/' . $schedule->id . '/edit') }}"> Modify</a>
                                        </td>
                                        <td>
